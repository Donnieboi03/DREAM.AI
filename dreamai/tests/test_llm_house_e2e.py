...
# Repo root and dreamai/scripts on path (dreamai package + ThorEnv's "from actions import ...")
REPO_ROOT = Path(__file__).resolve().parent.parent.parent
SCRIPTS_DIR = REPO_ROOT / "dreamai" / "scripts"
...
def test_llm_house_e2e_user_input_to_simulation():
    ...
    from dreamai.backend.llm import run_full_pipeline
