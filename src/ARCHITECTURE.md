...
- **Docker:** For containerized build and run (mainly for Windows; ARM with `--platform=linux/amd64`), see **../docker/README.md**.
...
```python
from src.backend.schemas import SceneSpec, TaskSpec, RewardSpec, FailureReport
